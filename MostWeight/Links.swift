...
enum Links {
    ...
    static let terms = URL(
        string:
            "https://docs.google.com/document/d/e/2PACX-1vQredqKEw5z7oyoRtl8nu0Plh0eqp25mmLI6qNXmFQYcvSGsHWduQr1CNNBtDRAWrYsWfVF5dOJtMjj/pub"
    )!
    static let policy = URL(
        string:
            "https://docs.google.com/document/d/e/2PACX-1vQredqKEw5z7oyoRtl8nu0Plh0eqp25mmLI6qNXmFQYcvSGsHWduQr1CNNBtDRAWrYsWfVF5dOJtMjj/pub"
    )!
    static let mainpolicy = URL(string: "https://asolab.store/RVkZnM")!
